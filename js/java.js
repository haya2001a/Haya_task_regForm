...
document.getElementById('bod').max =currentDate.toISOString().split("T")[0];
//classes : 
class person{
...
if(name==='' || dob==='' ||gender==='Gender' ||city==='Your Birth Cirty' ||type==='Person Type'){
    ...
    if(type==='Student'){
        if(age>9 && age<18){
            ...
            swal('oops...','your age should be between 9 & 18 !','error');  
            e.preventDefault(); 
        }
    }else{
        if(age>22){
            ...
            swal('oops...','your age should be more than 22  !','error');  
            e.preventDefault(); 
        }
